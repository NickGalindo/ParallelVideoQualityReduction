...
int main(int argc, char* argv[]){
  ...
  for(ll i = 0; i < frames; i++){
    ...
    if((i+1) % num_batch_process_frames == 0 || (i+1) == frames || frame.empty()){
      cout << "FUCKITYFUCK FUCK FUCKER: " << (i+1)/num_batch_process_frames << endl;
      cout << i << " " << frames << endl;
      ...
      cout << blocks << " " << threads_per_block << endl;
      ...
      cout << "GOD FUCKING DAMMIT MOTHER FUCKER" << endl;
      ...
      cout << "WHAT THE SHITTY SHIT SHIT" << endl;
